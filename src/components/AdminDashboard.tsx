                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500 flex items-center gap-1">
                            ...
                            {new Date(submission.timestamp).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}
                          </div>
                        </div>
                      </div>
                    </td>
            ...
            <div className="mt-3">
              ...
              <div className="space-y-8 max-h-[80vh] overflow-y-auto print:max-h-none print:overflow-visible">
                ...
                <div className="border-b pb-4 print:pb-2">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2">{new Date(selectedSubmission.timestamp).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}</span>
                    </div>
                    <div>
                ...
                <div className="border-t pt-4 text-center text-sm text-gray-500 print:pt-2">
                  <p>Generated by TeachMeAI IMPACT Assistant • {new Date(selectedSubmission.timestamp).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}</p>
                </div>
              </div>
            </div>
          </div>
